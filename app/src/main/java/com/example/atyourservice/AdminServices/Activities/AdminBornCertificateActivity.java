...
public class AdminBornCertificateActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(AdminBornCertificateActivity.this, HomeActivity.class));
        finish();
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_born_certificate);
    ...
    private void GetData() {
        try{
            ...
            db.collection("PendingService")
                    .whereEqualTo("Service_Name", "شهادة ميلاد")
                ...
                public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                    ...
                    if(!mRequestsList.isEmpty()){
                        AdminMyAdapter adminMyAdapter = new AdminMyAdapter(AdminBornCertificateActivity.this, mRequestsList, AdminBornCertificateActivity.this);
