...
public class AdminDriverLicenceActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(AdminDriverLicenceActivity.this, HomeActivity.class));
        finish();
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_driver_licence);
    ...
    private void GetData() {
        try{
            ...
            db.collection("PendingService")
                    .whereEqualTo("Service_Name", "رخصة قيادة")
                ...
                public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                    ...
                    if(!mRequestsList.isEmpty()){
                        AdminMyAdapter adminMyAdapter = new AdminMyAdapter(AdminDriverLicenceActivity.this, mRequestsList, AdminDriverLicenceActivity.this);
