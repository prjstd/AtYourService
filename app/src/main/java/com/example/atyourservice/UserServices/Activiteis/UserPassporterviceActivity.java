...
public class UserPassporterviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_passport_service);
...
//                    test.add(gr.get(0).toObject(Users.class));
                        if(gr.get(i).getString("id").equals("passportService")){
...
//                            editor.apply();
                            ...
                            final AlertDialog.Builder builder = new AlertDialog.Builder((UserPassporterviceActivity.this));
                            LayoutInflater inflater = (UserPassporterviceActivity.this).getLayoutInflater();
                            ...
                            btnOk.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    startActivity(new Intent(UserPassporterviceActivity.this,HomeActivity.class));
